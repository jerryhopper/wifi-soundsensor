...
const i2s_config_t i2s_config = {
  ...
  .channel_format       = i2s_config_channel_format,                  // although the SEL config should be left, it seems to transmit on right, or not
...
const i2s_pin_config_t pin_config = {
    .bck_io_num = i2s_pin_bck_io_num,
    .ws_io_num = i2s_pin_ws_io_num,
    .data_out_num = i2s_pin_data_out_num, // not used (only for speakers)
    .data_in_num = i2s_pin_ata_in_num 
};
